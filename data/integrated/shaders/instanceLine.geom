/*
    ...
    1) Vertex Shader
        Outputs vertices to clip space

    2) Geometry Shader
        Modifies the primitives from Vertex Shader

    3) Shape Assembly / Fixed Functions
        Perspective Division

    4) Fragment Shader and then viewport transform
*/
...
How to create line with with x
