...
class ResourceManager : IResourceManager{
    ...
    override fun loadFontFromDisc(id: String, font: File, glyphs: String, size: Int) {
        ...
        val glTextureObject: Int = loadTextureToOpenGL(textureData, squareTextureSize, squareTextureSize, GL11.GL_LINEAR_MIPMAP_LINEAR, GL11.GL_NEAREST, false)
    ...
    private fun loadMeshIntoOpenGL(meshID: String, mesh: Mesh, instancedRenderer: InstancedRenderer, mode: PrimitiveMode, attributeMapper: () -> Int) : GLMesh {
        ...
        //Map OpenGL attribute Objects (Vertex Positions, Texture Positions)
        ...
        //Map OpenGL Instanced Rendering Attributed via the custom mapper
        instancedRenderer.bindToVertexArray()
        val mappings = attributeMapper()
